...
# This feels less like DiffieHellman because it doesn't generate a shared secret
#There's a different way to do this : https://cryptography.io/en/latest/hazmat/primitives/asymmetric/ec/ , seems potentially unsafe
class DiffieHellman:
    def __init__(self):
